                ...
                <ThemeProvider theme={theme}>
                    <Grid container spacing={3} justifyContent="center">
                        <Grid item xs={12} sm={6} md={6} lg={4} xl={4} >
                            <Card sx={{ maxWidth: '100%', justifyContent: 'center', textAlign: 'center' }}>
                                <CardMedia
                                    component="img"
                                    alt="profile"
                                    height="100"
                            ...
                            <Card>
                                <CardContent>
                                    <Grid container spacing={2} style={{ marginLeft: '0.1em' }}>
                                        ...
                                        <Grid item xs={10} style={{ marginTop: '0.4em' }}>
                                            <FormLabel id="demo-radio-buttons-group-label-6">Gender</FormLabel>
                                        </Grid>
                                        <Grid item container xs={10} justifyContent="center">
                                            <Grid item xs={8}>
                                                ...
                                                >
                                                    ...
                                                    <FormControlLabel style={{ marginLeft: "1em" }} value="other" control={<Radio />} label="Other" />
                                                </RadioGroup>
                                            </Grid>
                                        </Grid>
                                        <Grid item xs={10} style={{ marginTop: '0.4em' }}>
                                            <FormLabel id="demo-radio-buttons-group-label-7">Date Of Birth</FormLabel>
                                        </Grid>
                                        <Grid item xs={10}>
                                            <DatePicker
                                        ...
                                        <Grid item xs={10} style={{ marginTop: '0.4em' }}>
                                            <FormLabel id="demo-radio-buttons-group-label-9">State</FormLabel>
                                        </Grid>
                                        <Grid item xs={10}>
                                            <Select
                    ...
                    <Grid container spacing={3} justifyContent="center" style={{ marginTop: '5em' }} >
                        <Grid item xs={12} sm={6} md={6} lg={4} xl={4} style={{ textAlign: 'center' }}>
                            <Button variant="contained" color="error" onClick={handleLogIn} style={{ marginTop: '1em' }} sx={{ fontFamily: 'Quicksand', fontWeight: 'bold' }}>
                                Logout
                                <LogoutIcon />
                            </Button>
                        </Grid>
